...
- 최신 배포 번들: `jasca-offline-scan-target-display-20260622-bundle.tar.gz`
- 체크섬 파일: `jasca-offline-scan-target-display-20260622-SHA256SUMS.txt`
...
- [JASCA 통합 사용설명서](docs/User_Manual_kr.md)
